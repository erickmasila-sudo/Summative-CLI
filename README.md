...
```bash
python3 main.py --debug add-user --name "Wayne" --email "wayne@example.com"
```
...
Add a user:
```bash
python3 main.py add-user --name "Wayne" --email "wayne374@gmail.com"
```

Create a project for a user:
```bash
python3 main.py add-project --user "Wayne" --title "Python Basics" --due-date "2026-06-30"
```

Add a task to a project:
```bash
python3 main.py add-task --user "Watne" --project "Python Basics" --title "Implement add-task"
```

List a user's projects:
```bash
python3 main.py list-projects --user "Racel"
```

Search a user's projects by keyword:
```bash
python3 main.py search-projects --user "Wayne" --query "Python"
```

List tasks in a project:
```bash
python3 main.py list-tasks --user "Wayne" --project "Python Basics"
```

Mark a task complete:
```bash
python3 main.py complete-task --user "Alex" --project "Python Basics" --task "Implement add-task"
```
